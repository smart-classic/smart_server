...
def default_ns():
    ...
    d['clin'] = RDF.NS('http://smartplatforms.org/clinical#')
    d['core'] = RDF.NS('http://smartplatforms.org/core#')
    d['med'] = RDF.NS('http://smartplatforms.org/clinical/medication#')
    d['allergy'] = RDF.NS('http://smartplatforms.org/clinical/allergy#')
    d['spdemo'] = RDF.NS('http://smartplatforms.org/clinical/demographics#')
