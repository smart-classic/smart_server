...
# Is this ever used? -JM  url(r'^authorize$',        user_authorization, name='oauth_user_authorization'),
  ...
  url(r'^internal/request_tokens/(?P<request_token>[^/]+)/claim$', 
          request_token_claim, name='oauth_internal_request_token_claim'),
  url(r'^internal/request_tokens/(?P<request_token>[^/]+)/info$', 
          request_token_info, name='oauth_internal_request_token_info'),
  url(r'^internal/request_tokens/(?P<request_token>[^/]+)/approve$', 
