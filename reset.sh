...
wget --post-data='context='  http://localhost:8080/openrdf-workbench/repositories/temp_rdf/clear -O /dev/null
wget --post-data='type=native&Repository+ID=temp_rdf&Repository+title=Container-level+RDF+for+temporary_storage&Triple+indexes=spoc%2Cposc'  http://localhost:8080/openrdf-workbench/repositories/NONE/create -O /dev/null
