...
<rdf:Description>
  ...
  <xsl:attribute name="rdf:about"><xsl:value-of select="@id"/></xsl:attribute>
  	    ...
  	    <med:doseUnits><xsl:attribute name="rdf:resource">med:<xsl:value-of select='translate(normalize-space(.//Dose/Units), $uppercase, $smallcase)'/></xsl:attribute></med:doseUnits>
  	    <med:route><xsl:attribute name="rdf:resource">med:<xsl:value-of select='translate(normalize-space(.//Route/Text), $uppercase, $smallcase)'/></xsl:attribute></med:route>
...
<xsl:attribute name="rdf:about">rxn-cui:<xsl:value-of select="$cui"/></xsl:attribute>
  	    ...
  	    <med:strengthUnits><xsl:attribute name="rdf:resource">med:<xsl:value-of select='translate(normalize-space(.//Strength/Units), $uppercase, $smallcase)'/></xsl:attribute></med:strengthUnits>
  	    <med:form><xsl:attribute name="rdf:resource">med:<xsl:value-of select='translate(normalize-space(.//Product/Form/Text), $uppercase, $smallcase)'/></xsl:attribute></med:form>
</rdf:Description>
</xsl:template>
